"""Stage8 画像: 緑背景をChroma Keyで透過 + タイトクロップ。"""
from pathlib import Path
from PIL import Image

SRC = Path(r"D:\ゲーム制作\station-builder\assets\Gemini_Generated_Image_kvririkvririkvri.png")
OUT_FINAL = Path(r"D:\ゲーム制作\station-builder\assets\station_stage8.png")
...
# 上部を少し削って横長化（万国旗の一部を残しつつ）
cw, ch = cropped.size
top_crop = int(ch * 0.10)
